      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
			...
			<div style="float:left;">
				<a href="index_ADE.html" class="logo"><img src="img/Gfi_logo.png" /><b>AGRAF - Application de Gestion des Reste A Faire</b></a>
            </div>
			<!--logo end-->
					
            <div class="nav notify-row" id="top_menu" style="margin-top:35px; margin-left:15px;">
                <!--  notification start -->
                <ul class="nav top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended tasks-bar">
                            ...
                            <li class="external">
                                <a href="#">Voir tous les périmètres</a>
                            </li>
                        </ul>
                    </li>
                    <!-- settings end -->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse " style="margin-top: 40px;">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <h5 class="centered">Alan Delahaye</h5>
                      		...
                      		<div class="white-panel pn donut-chart">
								...
								<div class="row">
									<div class="col-sm-6 col-xs-6 goleft">
										<p><i class="fa fa-database"></i> 90%</p>
									</div>
	                      		</div>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-4 mb">
							...
							<div class="darkblue-panel pn">
								...
								<div class="chart mt">
									<div class="sparkline" data-type="line" data-resize="true" data-height="75" data-width="90%" data-line-width="1" data-line-color="#fff" data-spot-color="#fff" data-fill-color="" data-highlight-line-color="#fff" data-spot-radius="4" data-data="[200,135,667,333,526,996,564,123,890,464,655,800,900,1100,2100]"></div>
								</div>
